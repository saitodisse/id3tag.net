	...
	public class HeaderTest : Test
	{
		...
		public void FooterTest1()
		{
			...
			var headerBytes = new byte[]
			                  	{
			                  		0x49, 0x44, 0x33, 0x04, 0x00, 0x10, 0x00, 0x00, 0x00, 0x14,
			...
			Assert.IsTrue(m_TagInfo.HasFooter);
		...
		public void FooterTest2()
		{
			...
			Assert.IsFalse(m_TagInfo.Experimental);
			Assert.IsFalse(m_TagInfo.ExtendedHeaderAvailable);
			Assert.IsFalse(m_TagInfo.HasFooter);
		}
		...
		public void HeaderSizeTes4()
		{
			var headerBytes = new byte[]
			                  	{
			                  		0x49, 0x44, 0x33, 0x03, 0x00, 0xA0, 0x00, 0x00, 0x00, 0x04,
			                  		0x00, 0x00, 0x00, 0x00
			                  	};
			Read(headerBytes);
		...
		public void HeaderSizeTes5()
		{
			var headerBytes = new byte[]
			                  	{
			                  		0x49, 0x44, 0x33, 0x03, 0x00, 0xA0, 0x00, 0x00, 0x01, 0x20,
